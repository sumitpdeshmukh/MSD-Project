...
public class HDF5GettersV2
{
    ...
    public static void extractSongInfo(String filename, FileWriter fw) {
    	...
    	try {
    		...
    		if (number == 20) {
    			//fw.write("Analysis sample rate" + ",");
    			fw.write("Artist 7dID" + ",");
    			fw.write("Artist familiarity" + ",");
    			fw.write("Artist hotness" + ",");
    			fw.write("Artist ID" + ",");
    			fw.write("Artist latitude" + ",");
    			fw.write("Artist location" + ",");
    			fw.write("Artist longitude" + ",");
    			fw.write("Artist name" + ",");
    			fw.write("Audio MD5" + ",");
    			fw.write("Number of beats" + ",");
    			fw.write("Danceability" + ",");
    			fw.write("Duration" + ",");
    			fw.write("End of fade in" + ",");
    			fw.write("Energy" + ",");
    			fw.write("loudness" + ",");
    			fw.write("release" + ",");
    			fw.write("release 7dID" + ",");
    			fw.write("Hotness" + ",");
    			fw.write("SongID" + ",");
    			fw.write("Start of fade out" + ",");
    			fw.write("Tempo" + ",");
    			fw.write("Title" + ",");
    			fw.write("TrackID" + ",");
    			fw.write("Track 7dID" + ",");
    ...
    public static void main(String[] args) throws IOException
    {
		...
		File fileToWrite = new File("bigdatafile.csv");
